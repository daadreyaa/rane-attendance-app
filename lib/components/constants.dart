...
TextStyle kTableColumnText = GoogleFonts.lexendDeca(fontSize: 16, fontWeight: FontWeight.bold);
TextStyle kTableRowText = GoogleFonts.lexendDeca(fontSize: 14, fontWeight: FontWeight.normal);
